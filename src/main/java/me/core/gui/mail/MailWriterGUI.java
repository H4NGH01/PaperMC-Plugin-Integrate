...
public class MailWriterGUI extends GUIBase {
    ...
    private @NotNull InventoryItem title() {
        InventoryItem item = new InventoryItem(Material.PAPER).addTag("ItemTag", "gui.mail.writer.title");
    ...
    private @NotNull InventoryItem to() {
        InventoryItem item = new InventoryItem(Material.PLAYER_HEAD).addTag("ItemTag", "gui.mail.writer.to");
        ...
        if (this.mail.getAddressee().length > 0) {
            ...
            builder.append(ComponentUtil.translate(ChatColor.GREEN, "gui.none"));
        }
    ...
    private @NotNull InventoryItem text() {
        InventoryItem item = new InventoryItem(Material.PAPER).addTag("ItemTag", "gui.mail.writer.text");
    ...
    private @NotNull InventoryItem attachment() {
        InventoryItem item = new InventoryItem(Material.PAPER).addTag("ItemTag", "gui.mail.writer.attachment");
    ...
    private @NotNull InventoryItem send() {
        InventoryItem item = new InventoryItem(Material.GREEN_CONCRETE).addTag("ItemTag", "gui.mail.writer.send");
