...
public class MailPlayerSelectorGUI extends MultiplePageGUI {
    ...
    public static @NotNull InventoryItem playerIcon(@NotNull OfflinePlayer p, boolean glow) {
        InventoryItem icon = new InventoryItem(Material.PLAYER_HEAD).addTag("ItemTag", "gui.mail.selector.player_icon");
    ...
    private @NotNull InventoryItem info() {
        InventoryItem item = new InventoryItem(Material.PAPER).addTag("ItemTag", "gui.mail.selector.info");
