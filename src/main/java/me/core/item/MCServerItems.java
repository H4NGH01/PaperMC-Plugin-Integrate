...
public class MCServerItems {
    ...
    public final static InventoryItem air = newInventoryItem(Material.LIGHT_GRAY_STAINED_GLASS_PANE, Component.text(" ")).addTag("ItemTag", "gui.air");
    public final static InventoryItem board = newInventoryItem(Material.GRAY_STAINED_GLASS_PANE, Component.text(" ")).addTag("ItemTag", "gui.board");
    public final static InventoryItem next = newInventoryItem(Material.ARROW, Component.translatable("gui.next")).addTag("ItemTag", "gui.next");
    public final static InventoryItem prev = newInventoryItem(Material.ARROW, Component.translatable("gui.prev")).addTag("ItemTag", "gui.prev");
    public final static InventoryItem back = newInventoryItem(Material.ARROW, Component.translatable("gui.back")).addTag("ItemTag", "gui.back");
    public final static InventoryItem close = newInventoryItem(Material.BARRIER, Component.translatable("gui.close")).addTag("ItemTag", "gui.close");
