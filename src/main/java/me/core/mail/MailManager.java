...
public class MailManager {
    ...
    public void save() {
        ...
        this.mailFile.write();
        //Save new mail data
        List<NewMail> newMailList = new ArrayList<>();
        for (MailWriterGUI mwg : MailWriterGUI.VIEW_MAP.values()) {
            newMailList.add(mwg.getMail());
        }
